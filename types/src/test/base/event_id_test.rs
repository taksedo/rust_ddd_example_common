...
fn create_event__check_event_id_is_unique() {
    ...
    assert_ne!(firstEvent.domain_events_params.id, secondEvent.domain_events_params.id);
    assert_ne!(firstEvent.domain_events_params.id.value, secondEvent.domain_events_params.id.value)
}
